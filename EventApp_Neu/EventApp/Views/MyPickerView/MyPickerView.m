...
+ (MyPickerView*)sharedView {
    static dispatch_once_t once;
    static MyPickerView *sharedView;
...
-(void)dismiss{
    [MyPickerView dismissWithCompletion:self.onDismissCompletion];
}
...
-(void)initializePickerViewInView: (UIView *)view
    ...
    _pickerDoneButton = [[UIButton alloc] initWithFrame:CGRectMake(_pickerContainerView.frame.size.width - 60.0, 10.0, 60.0, 24.0)];
    ...
    [_pickerDoneButton setTitleColor:[UIColor colorWithRed:0 green:0 blue:1.0 alpha:0.5] forState:UIControlStateHighlighted];
